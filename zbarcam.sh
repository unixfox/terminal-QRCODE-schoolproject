...
do
	...
	zenity --info --text "Bonjour $surname $name !\nVeuillez regardez la caméra Microsoft jusqu'à ce que le témoin vert apparait\npour prendre une photo de vous attestant que vous êtes bien $surname $name." --timeout=10 --title="Vérification de présence"
	zenity --info --text "Capture en cours...\nVeuillez regarder l'objectif." --timeout=3 --title="Vérification de présence"
	fswebcam -d /dev/video1 -r 640x480 --jpeg 100 -D 3 capture/webcam-shot-$(date +%s).jpg
